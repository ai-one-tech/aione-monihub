...
#[derive(
    Clone, Debug, PartialEq, Eq, Serialize, Deserialize, DeriveActiveEnum, EnumIter, ToSchema,
)]
...
#[serde(rename_all = "snake_case")]
pub enum TaskType {
    #[sea_orm(string_value = "shell_exec")]
    ShellExec,
    #[sea_orm(string_value = "run_code")]
    RunCode,
    #[sea_orm(string_value = "file_manager")]
    FileManager,
    #[sea_orm(string_value = "custom_command")]
    CustomCommand,
    #[sea_orm(string_value = "http_request")]
    HttpRequest,
}
...
pub enum AgentType {
    ...
    Java,
    #[sea_orm(string_value = "rust_agent")]
    RustAgent,
}
...
pub enum NetworkType {
    #[sea_orm(string_value = "wired")]
    Wired,
    #[sea_orm(string_value = "wifi")]
    Wifi,
    #[sea_orm(string_value = "cellular")]
    Cellular,
    #[sea_orm(string_value = "unknown")]
    Unknown,
}
