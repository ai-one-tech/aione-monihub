...
export function OperationsLogsTable({
  data = [],
  totalPages,
  search,
  navigate,
  ...
  return (
    <div className='flex h-full min-h-0 flex-col'>
      ...
      <div className='mt-2 grid grid-cols-2 gap-2'>
        <Input
          type='datetime-local'
          value={toLocalInput(search['start_date'] as string | undefined)}
          onChange={(e) =>
            navigate({
              search: (prev) => ({
                ...prev,
                page: undefined,
                start_date: fromLocalInputToIso(e.target.value),
              }),
            })
          }
        />
        <Input
          type='datetime-local'
          value={toLocalInput(search['end_date'] as string | undefined)}
          onChange={(e) =>
            navigate({
              search: (prev) => ({
                ...prev,
                page: undefined,
                end_date: fromLocalInputToIso(e.target.value),
              }),
            })
          }
        />
